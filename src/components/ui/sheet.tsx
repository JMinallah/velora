    ...
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "inset-y-0 right-0 h-full w-[82vw] max-w-70 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-75",
          side === "left" &&
            "inset-y-0 left-0 h-full w-[82vw] max-w-70 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-75",
          side === "top" &&
